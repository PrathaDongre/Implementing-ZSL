...
train_agent = Trainer(
    ...
    batch_size=args.batch_size, dname = args.dataset
)
...
# =============================================================
# TRAIN THE GENERATOR AND ATTRIBUTE CLASSIFIER.
# =============================================================
model_name = "%s_f_and_g" % args.dataset
print(model_name, args.dataset)
success = train_agent.load_model(model=model_name)
if success:
    print("\ngenerator and att classifier parameters loaded....")
else:
    print("\nTraining f and g...")
    for ep in range (1, n_epochs + 1):
        c=0
