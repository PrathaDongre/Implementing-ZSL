...
#kaggle edit
        res101_data = scio.loadmat('../input/awa1-datasets/res101.mat' )
        ...
        #kaggle edit
        self.attribute_dict = scio.loadmat('../input/awa1-datasets/att_splits.mat')
        ...
        #kaggle edit
        self.class_names_file = '../input/awa1-splits/classes.txt'
        #self.class_names_file = './datasets/%s/classes.txt' % dset

        # test class names
        #kaggle edit
        with open('../input/awa1-splits/testclasses.txt') as fp:
